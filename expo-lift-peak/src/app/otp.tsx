...
const Otp = () => {
  ...
  const {mutate} = useMutation({
    ...
    onSuccess: res => {
      if(res) {
        router.push({pathname: "/resetPassword", params: {jwt: res}});
        return
      }
      showToast("error validating the code", "You entered the wrong code, please try again", "error")
    },
    onError: () => {
      showToast("Error validating the code", "The code is expired. Please enter new.", "error")
    }
  })
